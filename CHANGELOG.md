...
## [2.0.0](https://github.com/chaotic-ground/wikven/compare/v1.1.0...v2.0.0) (2026-09-20)


### ⚠ BREAKING CHANGES

* put the pictures pages carry where the rest of the output goes ([#592](https://github.com/chaotic-ground/wikven/issues/592))
* stop the build on three things it used to publish around ([#590](https://github.com/chaotic-ground/wikven/issues/590))
* put everything the build generates in one directory ([#584](https://github.com/chaotic-ground/wikven/issues/584))
...
* give the settings page the sentence written for it ([#753](https://github.com/chaotic-ground/wikven/issues/753)) ([6615b96](https://github.com/chaotic-ground/wikven/commit/6615b962a8d7afa0b32f70359afaf6c6db11e4e8))
